$(document).ready(function() {
    ...
    addRoomForm.on("submit", function(event) {
      ...
      addRoom(roomData.roomName, roomData.roomCapacity, roomData.roomURL, roomData.roomType,roomData.address1,roomData.address2, roomData.city,roomData.state_us,roomData.zip,roomData.contactPhone, roomData.roomRate);
      roomInput.val("");
      capacityInput.val("");
      roomURLInput.val("");
      roomTypeInput.val("");
    ...
    function addRoom(roomName, roomCapacity, roomURL, roomType, address1, address2, city, state_us, zip, contactPhone, roomRate) {
      $.post("/api/addroom", {
        roomName: roomName,
